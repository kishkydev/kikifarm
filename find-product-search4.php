...
$get = mysqli_query($con,"SELECT *
  ...
  WHERE  `users`.`state_name`='$state_name' AND $construct2 AND type='$type'   ") or die (mysqli_error());
...
$getproduct = mysqli_query($con,"SELECT *
  ...
  LEFT JOIN `products`
  ON `users`.`user_id` = `products`.`user_id`
  WHERE  `users`.`state_name`='$state_name' AND $construct2 AND type='$type' ORDER BY product_id DESC LIMIT $row_start, $limit ") or die (mysqli_error());
?>
   <script>              
 //...............to fetch town........................................
