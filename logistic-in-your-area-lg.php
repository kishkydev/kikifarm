...
$lg = $_GET['lg'];
 ...
 $query = mysqli_query($con,"SELECT * FROM local_governments WHERE lg_id = '$lg'  ");
      $row = mysqli_fetch_array($query);
       $lg_name = $row['name'];


$construct = "join_lg LIKE '%$lg_name%'";
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            <div class="page-title-heading">
                                <h1 class="title">Logistic in Your Local Goverment</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="ttm-textcolor-skincolor">Logistic in LG Area</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
