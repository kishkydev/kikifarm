                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="ttm-textcolor-skincolor">Farmers' Shops</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
...
$get = mysqli_query($con,"SELECT * FROM users WHERE user_type='farmer'  ") or die (mysqli_error());
...
$getproduct = mysqli_query($con,"SELECT * FROM users WHERE user_type='farmer' ORDER BY rand() DESC LIMIT $row_start, $limit  ") or die (mysqli_error()); 
?>
   <script>              
 //...............to fetch town........................................
...
//             $countrow_basket = mysqli_num_rows($check_if_added_basket);
 ...
 <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-icon-btn-left ttm-btn-bgcolor-darkgrey showsms" href="message?message=<?php echo $owner_id; ?>" title="" style="color: white; font-family:tahoma; font-family:tahoma"><b>Send Message</b> <i class="fa fa-comment"></i></a>


  <?php else : ?><!-- to check it user logged in -->

 <a class="ttm-btn ttm-btn-size-md ttm-btn-shape-square ttm-icon-btn-left ttm-btn-bgcolor-darkgrey notLoggedIn" href="javascript:;" id="notl<?php echo $owner_id; ?>" style="color: white; font-family:tahoma; font-family:tahoma"><b>Send Message</b> <i class="fa fa-comment"></i></a>
...
<?php endif; ?><!-- to check it user logged in -->
                                        ...
                                        <a href="<?php echo $owner; ?>"><span><?php if($shop_name != ''){echo $shop_name; }else{echo ucfirst($username); } ?></span></a>           
                                        </div>
...
<p style="color: #890912; margin-bottom:-5px"><b><?php echo $phone; ?></b></p>
                                        ...
                                        <a href="<?php echo $owner; ?>"  style="color: #e61b1b">
 ...
 -->
                ...
                <a href="#" class="page-numbers"><i class="ti ti-arrow-left"></i></a>
                 <?php else : ?>
                  <a class="previous page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $page-1; ?>"><i class="ti ti-arrow-left"></i></a>
                <?php endif; ?> 

                 <?php if($start > 1): ?>
                    <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=1">1</a>
                    <span>...</span>
                    <?php endif; ?>
                ...
                <?php for($y = $start; $y <= $end; $y++) : ?>
                    <?php if($page == $y) : ?>
                      <span><a class="current page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $y; ?>"><?php echo $y; ?></a></span>
                       <?php else : ?>
                        <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $y; ?>"><?php echo $y; ?></a>
                    <?php endif; ?> 
                    <?php endfor; ?>
                ...
                <?php if($end < $last): ?>
                    <span>...</span>
                    <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $last; ?>"><?php echo $last; ?></a>
                    <?php endif; ?>

                <?php if($page == $last): ?> 
                      <a href="#" class="next page-numbers"><i class="ti ti-arrow-right"></i></a>
                      <?php else : ?>
                      <a class="next page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $page+1; ?>"><i class="ti ti-arrow-right"></i></a>
                      <?php endif; ?>
