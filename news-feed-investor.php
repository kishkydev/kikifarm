                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            <div class="page-title-heading">
                                <h1 class="title">Latest Investors' Agro News Feed</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="ttm-textcolor-skincolor">Investors' Agro News Feed</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
...
$xml = simplexml_load_file("https://agfundernews.com/feed");
...
$xml = simplexml_load_file("https://www.agriinvestor.com/rss");
$url = 'https://www.agriinvestor.com/rss';
