...
<?php
   ...
   $query_basket = mysqli_query($con,"SELECT *
                                            ...
                                            WHERE `basket`.`added_by` = '$user_id' AND `basket`.`done` = 'no' AND `products`.`type` = '1'  ORDER BY `basket`.`id` DESC "); 
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            <div class="page-title-heading">
                                <h1 class="title">Food Tracker Basket (<?php echo $counter;  ?>)</h1>
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="ttm-textcolor-skincolor">Food Tracker Basket</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
...
<aside class="widget widget-categories">
             <h3 class="widget-title" style="color: #e61b1b; font-family: tahoma;">Check all basket items, click

                 <a class="ttm-btn ttm-btn-size-sm ttm-btn-shape-square ttm-icon-btn-right ttm-btn-bgcolor-skincolor" href="basket-products" title="">ALL BASKET <i class="fa fa-shopping-cart"></i></a>
             </h3>
         </aside>
