...
$get = mysqli_query($con,"SELECT * FROM users WHERE user_type='farmer' AND $construct AND state_name='$state_name'  ") or die (mysqli_error());
...
$getproduct = mysqli_query($con,"SELECT * FROM users WHERE user_type='farmer' AND $construct AND state_name='$state_name' ORDER BY user_id DESC LIMIT $row_start, $limit  ") or die (mysqli_error()); 
?>
   <script>              
 //...............to fetch town........................................
...
<p style="color: #890912; margin-bottom:-5px"><b><?php echo $phone; ?></b></p>
 ...
 -->
                ...
                <a href="#" class="page-numbers"><i class="ti ti-arrow-left"></i></a>
                 <?php else : ?>
                  <a class="previous page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $page-1; ?>&find_word=<?php echo $find_word; ?>&state_name=<?php echo $state_name; ?>"><i class="ti ti-arrow-left"></i></a>
                <?php endif; ?> 

                 <?php if($start > 1): ?>
                    <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=1&find_word=<?php echo $find_word; ?>&state_name=<?php echo $state_name; ?>">1</a>
                    <span>...</span>
                    <?php endif; ?>
                ...
                <?php for($y = $start; $y <= $end; $y++) : ?>
                    <?php if($page == $y) : ?>
                      <span><a class="current page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $y; ?>&find_word=<?php echo $find_word; ?>&state_name=<?php echo $state_name; ?>"><?php echo $y; ?></a></span>
                       <?php else : ?>
                        <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $y; ?>&find_word=<?php echo $find_word; ?>&state_name=<?php echo $state_name; ?>"><?php echo $y; ?></a>
                    <?php endif; ?> 
                    <?php endfor; ?>
                ...
                <?php if($end < $last): ?>
                    <span>...</span>
                    <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $last; ?>&find_word=<?php echo $find_word; ?>&state_name=<?php echo $state_name; ?>"><?php echo $last; ?></a>
                    <?php endif; ?>

                <?php if($page == $last): ?> 
                      <a href="#" class="next page-numbers"><i class="ti ti-arrow-right"></i></a>
                      <?php else : ?>
                      <a class="next page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $page+1; ?>&find_word=<?php echo $find_word; ?>&state_name=<?php echo $state_name; ?>"><i class="ti ti-arrow-right"></i></a>
                      <?php endif; ?>
