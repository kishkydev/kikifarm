...
$search_exploded = preg_split('/[\s]+/', $search_name);
...
$getproduct = mysqli_query($con,"SELECT * FROM products WHERE $construct ORDER BY product_id DESC LIMIT ".$_POST["start"].", ".$_POST["limit"]."  ") or die (mysqli_error()); 
