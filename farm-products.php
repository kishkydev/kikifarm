                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="ttm-textcolor-skincolor">Farm Products</span>
                            </div>  
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
...
$getproduct = mysqli_query($con,"SELECT * FROM products WHERE type='$type' ORDER BY product_id DESC LIMIT $row_start, $limit  ") or die (mysqli_error()); 
?>
   <script>              
 //...............to fetch town........................................
...
var find_word = $('#find_word').val(); 
 var state_name = $('#state_name').val(); 
  ...
  if (find_word  && !lg_name && !state_name)  {                       
          ...
          window.location.href = 'find-product-search4?lg_name='+lg_name+'&state_name='+state_name;  
      }
     else if (!find_word  && state_name  && !lg_name)  {  

          window.location.href = 'find-product-search5?state_name='+state_name;  
      }
      else if (find_word  && state_name  && lg_name)  {  
   ...
   //      window.location.href = 'farm-products-lg?type=<?php echo $type; ?>&lg='+search_lg;
                            ...
                            <div class="col-lg-4 col-md-6 col-sm-6">
                                <div class="product"><!-- product -->
                                    ...
                                    <div class="product-content text-left"><!-- product-content -->
                                        ...
                                        <div>
                                            <a href="javascript:;" id="warn<?php echo $product_id; ?>" style="color: #e61b1b;">
                                            <i class="fa fa-microphone"></i> 
                                                <span style="color: #173e43">Voice in Native Languages</span>
                                            </a> 
                                        </div>

                                    <div id="warning<?php echo $product_id; ?>" style="display: none;">
                                       <?php
                                        $result1 = $trans->translate($source, $target1, $prod_description);
                                        $result2 = $trans->translate($source, $target2, $prod_description);
                                        $result3 = $trans->translate($source, $target3, $prod_description);
                                        $result4 = $trans->translate($source, $target4, $prod_description);
                                       
                                       ?>


<div>
<input id="texten<?php echo $product_id; ?>" type="hidden" value="<?php echo $result1; ?>" />  
<input id="textyo<?php echo $product_id; ?>" type="hidden" value="<?php echo $result2; ?>" />  
<input id="textib<?php echo $product_id; ?>" type="hidden" value="<?php echo $result3; ?>" />  
<input id="textha<?php echo $product_id; ?>" type="hidden" value="<?php echo $result4; ?>" />  

<button class="ttm-btn ttm-btn-size-xs ttm-btn-shape-round ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey" href="javascript:;" id="btnSpeak1<?php echo $product_id; ?>" style="font-family:tahoma; font-family:tahoma"><span class="fa fa-microphone"></span> <small>English</small></button> 

 <button class="ttm-btn ttm-btn-size-xs ttm-btn-shape-round ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey" href="javascript:;" id="btnSpeak3<?php echo $product_id; ?>" style="font-family:tahoma; font-family:tahoma"><span class="fa fa-microphone"></span> <small>Ibo</small></button>

 <button class="ttm-btn ttm-btn-size-xs ttm-btn-shape-round ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey" href="javascript:;" id="btnSpeak2<?php echo $product_id; ?>" style="font-family:tahoma; font-family:tahoma"><span class="fa fa-microphone"></span> <small>Yoruba</small></button>



 <button class="ttm-btn ttm-btn-size-xs ttm-btn-shape-round ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-darkgrey" href="javascript:;" id="btnSpeak4<?php echo $product_id; ?>" style="font-family:tahoma; font-family:tahoma"><span class="fa fa-microphone"></span> <small>Hausa</small></button>                                   

<hr>

 <a class="ttm-btn ttm-btn-size-xs ttm-btn-shape-round ttm-btn-style-border ttm-icon-btn-right ttm-btn-color-skincolor" href="javascript:;" id="warned<?php echo $product_id; ?>" style="font-family:tahoma; font-family:tahoma"><span class="fa fa-power-off"></span> Close</a>
</div>

    <script>

//for english...................
var texten<?php echo $product_id; ?> = document.getElementById('texten<?php echo $product_id; ?>').value;

btnSpeak1<?php echo $product_id; ?>.addEventListener('click', event => {
    event.preventDefault();

 
    const utterance = new SpeechSynthesisUtterance(texten<?php echo $product_id; ?>);
    const voice = speechSynthesis.getVoices().find(voice => voice.name === 'Google polski');
   // voice.default = false;
...
//for yoruba...................
var textyo<?php echo $product_id; ?> = document.getElementById('textyo<?php echo $product_id; ?>').value;

btnSpeak2<?php echo $product_id; ?>.addEventListener('click', event => {
    event.preventDefault();

 
    const utterance = new SpeechSynthesisUtterance(textyo<?php echo $product_id; ?>);
    const voice = speechSynthesis.getVoices().find(voice => voice.name === 'Google polski');
   // voice.default = false;
    utterance.voice = voice;
    window.speechSynthesis.speak(utterance);
...
//for Ibo...................
var textib<?php echo $product_id; ?> = document.getElementById('textib<?php echo $product_id; ?>').value;

btnSpeak3<?php echo $product_id; ?>.addEventListener('click', event => {
    event.preventDefault();

 
    const utterance = new SpeechSynthesisUtterance(textib<?php echo $product_id; ?>);
    const voice = speechSynthesis.getVoices().find(voice => voice.name === 'Google polski');
   // voice.default = false;
    utterance.voice = voice;
    window.speechSynthesis.speak(utterance);
...
//for hausa...................
var textha<?php echo $product_id; ?> = document.getElementById('textha<?php echo $product_id; ?>').value;

btnSpeak4<?php echo $product_id; ?>.addEventListener('click', event => {
    event.preventDefault();

 
    const utterance = new SpeechSynthesisUtterance(textha<?php echo $product_id; ?>);
    const voice = speechSynthesis.getVoices().find(voice => voice.name === 'Google polski');
   // voice.default = false;
    utterance.voice = voice;
    window.speechSynthesis.speak(utterance);
    ...
    <script type="text/javascript">
                   ...
                   $(document).on('click', '#warn<?php echo $product_id; ?>', function() {
                                $("#warning<?php echo $product_id; ?>").slideDown("slow");
                                 document.getElementById('warning<?php echo $product_id; ?>').style.display="block";
                                  document.getElementById('warn<?php echo $product_id; ?>').style.display="none";
                       });
                  $(document).on('click', '#warned<?php echo $product_id; ?>', function() {
                                    $("#warning<?php echo $product_id; ?>").slideUp("slow");
                                 document.getElementById('warning<?php echo $product_id; ?>').style.display="none";
                                 document.getElementById('warn<?php echo $product_id; ?>').style.display="block";
                       });
