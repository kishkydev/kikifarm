...
$get = mysqli_query($con,"SELECT *
  ...
  WHERE  `users`.`state_name`='$state_name' AND  type='$type' ") or die (mysqli_error());
...
$getproduct = mysqli_query($con,"SELECT *
  ...
  LEFT JOIN `products`
  ON `users`.`user_id` = `products`.`user_id`
  WHERE  `users`.`state_name`='$state_name' AND type='$type' ORDER BY product_id DESC LIMIT $row_start, $limit ") or die (mysqli_error());
?>
   <script>              
 //...............to fetch town........................................
                    ...
                    <div class="col-md-12"> 
                        <div class="title-box text-left">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <span class="ttm-textcolor-skincolor"><?php echo $state_name; ?></span>
                            </div>   
                        </div>
                    </div><!-- /.col-md-12 -->  
                </div><!-- /.row -->  
...
<script type="text/javascript">
 ...
 -->
                ...
                <a href="#" class="page-numbers"><i class="ti ti-arrow-left"></i></a>
                 <?php else : ?>
                  <a class="previous page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $page-1; ?>&type=<?php echo $type; ?>&state_name=<?php echo $state_name; ?>"><i class="ti ti-arrow-left"></i></a>
                <?php endif; ?> 

                 <?php if($start > 1): ?>
                    <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=1&type=<?php echo $type; ?>&state_name=<?php echo $state_name; ?>">1</a>
                    <span>...</span>
                    <?php endif; ?>
                ...
                <?php for($y = $start; $y <= $end; $y++) : ?>
                    <?php if($page == $y) : ?>
                      <span><a class="current page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $y; ?>&type=<?php echo $type; ?>&state_name=<?php echo $state_name; ?>"><?php echo $y; ?></a></span>
                       <?php else : ?>
                        <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $y; ?>&type=<?php echo $type; ?>&state_name=<?php echo $state_name; ?>"><?php echo $y; ?></a>
                    <?php endif; ?> 
                    <?php endfor; ?>
                ...
                <?php if($end < $last): ?>
                    <span>...</span>
                    <a class="page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $last; ?>&type=<?php echo $type; ?>&state_name=<?php echo $state_name; ?>"><?php echo $last; ?></a>
                    <?php endif; ?>

                <?php if($page == $last): ?> 
                      <a href="#" class="next page-numbers"><i class="ti ti-arrow-right"></i></a>
                      <?php else : ?>
                      <a class="next page-numbers" href="?limit=<?php echo $limit; ?>&page=<?php echo $page+1; ?>&type=<?php echo $type; ?>&state_name=<?php echo $state_name; ?>"><i class="ti ti-arrow-right"></i></a>
                      <?php endif; ?>
